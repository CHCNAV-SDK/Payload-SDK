...
static const char *g_cameraManagerSampleSelectList[] = {
    [CHCNAV_TEST_CAMERA_MANAGER_SAMPLE_SELECT_SET_CAMERA_EXPOSURE_MODE] =
    ...
    [CHCNAV_TEST_CAMERA_MANAGER_SAMPLE_SELECT_SET_METERING_POINT] =
        "Set and get camera metering point                   |",
};

/* Private functions declaration ---------------------------------------------*/
static void chcnav_camare_manager_show_string_list(const char **list,
                                                   int size) {
...
static void chcnav_camare_manager_show_sample_list(void) {
  chcnav_camare_manager_show_string_list(
      g_cameraManagerSampleSelectList,
      ARRAY_SIZE(g_cameraManagerSampleSelectList));
}

chcnav_return_code_t
test_camera_manager_start_single_photo(CHCNAV_MOUNT_POSITION_E position) {
  chcnav_return_code_t ret;

  ret = chcnav_camera_manager_set_mode(
      position, CHCNAV_CAMERA_MANAGER_WORK_MODE_SHOOT_PHOTO);
  if (ret != CHCNAV_RETURN_OK) {
    printf(
        "Set mounted position %d camera's work mode failed, error code: %d\r\n",
        position, ret);
    return ret;
  }

  return chcnav_camera_manager_start_shoot_photo(
      position, CHCNAV_CAMERA_MANAGER_SHOOT_PHOTO_MODE_SINGLE);
}

chcnav_return_code_t
test_camera_manager_start_interval_photo(CHCNAV_MOUNT_POSITION_E position) {
  chcnav_return_code_t ret;
  ...
  ret =
      chcnav_camera_manager_set_photo_time_interval_settings(position, setting);
  if (ret != CHCNAV_RETURN_OK) {
    printf("Set mounted position %d camera's photo interval failed, error "
           "code: %d\r\n",
           position, ret);
    return ret;
  }
  ...
  return chcnav_camera_manager_start_shoot_photo(
      position, CHCNAV_CAMERA_MANAGER_SHOOT_PHOTO_MODE_INTERVAL);
}

chcnav_return_code_t
test_camera_manager_start_video_record(CHCNAV_MOUNT_POSITION_E position) {
  chcnav_return_code_t ret;

  ret = chcnav_camera_manager_set_mode(
      position, CHCNAV_CAMERA_MANAGER_WORK_MODE_RECORD_VIDEO);
  if (ret != CHCNAV_RETURN_OK) {
    printf(
        "Set mounted position %d camera's work mode failed, error code: %d\r\n",
        position, ret);
...
void run_camera_manager_sample(CHCNAV_MOUNT_POSITION_E position,
                               CHCNAV_TEST_CAMERA_MANAGER_SAMPLE_E sample) {
  chcnav_return_code_t ret;
  ...
  case CHCNAV_TEST_CAMERA_MANAGER_SAMPLE_SELECT_SET_CAMERA_EXPOSURE_MODE: {
    ...
    if (ret != CHCNAV_RETURN_OK) {
      printf("Get mounted position %d camera's exposure mode failed, error "
             "code: %d\r\n",
             position, ret);
      return;
    }
    ...
    if (ret != CHCNAV_RETURN_OK) {
      printf("Set mounted position %d camera's exposure mode failed, error "
             "code: %d\r\n",
             position, ret);
    }
    break;
  ...
  case CHCNAV_TEST_CAMERA_MANAGER_SAMPLE_SELECT_SET_CAMERA_SHUTTER_SPEED: {
    CHCNAV_CAMERA_MANAGER_SHUTTER_SPEED_E shutter =
        CHCNAV_CAMERA_MANAGER_SHUTTER_SPEED_1_100;
    printf("--> Function: Set camera shutter speed to 1/100 s...\n");
    ret = chcnav_camera_manager_set_exposure_mode(
        position, CHCNAV_CAMERA_MANAGER_EXPOSURE_MODE_EXPOSURE_MANUAL);
    if (ret != CHCNAV_RETURN_OK) {
      printf("Set mounted position %d camera's exposure mode failed, error "
             "code: %d\r\n",
             position, ret);
    ...
    if (ret != CHCNAV_RETURN_OK) {
      printf("Set mounted position %d camera's shutter speed failed, error "
             "code: %d\r\n",
             position, ret);
    }
    break;
  ...
  case CHCNAV_TEST_CAMERA_MANAGER_SAMPLE_SELECT_SET_CAMERA_APERTURE: {
    ...
    ret = chcnav_camera_manager_set_aperture(
        position, CHCNAV_CAMERA_MANAGER_APERTURE_F_2);
    if (ret != CHCNAV_RETURN_OK) {
      printf("Set mounted position %d camera's aperture failed, error code: "
             "%d\r\n",
             position, ret);
      return;
    }
  ...
  case CHCNAV_TEST_CAMERA_MANAGER_SAMPLE_SELECT_SET_CAMERA_EV: {
    ...
    ret = chcnav_camera_manager_set_exposure_compensation(
        position, CHCNAV_CAMERA_MANAGER_EXPOSURE_COMPENSATION_P_1_0);
    if (ret != CHCNAV_RETURN_OK) {
  ...
  case CHCNAV_TEST_CAMERA_MANAGER_SAMPLE_SELECT_SET_CAMERA_ISO: {
    ...
    ret =
        chcnav_camera_manager_set_ISO(position, CHCNAV_CAMERA_MANAGER_ISO_400);
    if (ret != CHCNAV_RETURN_OK) {
  ...
  case CHCNAV_TEST_CAMERA_MANAGER_SAMPLE_SELECT_ZOOM: {
    ...
    ret = chcnav_camera_manager_start_continuous_zoom(
        position, CHCNAV_CAMERA_ZOOM_DIRECTION_IN);
    if (ret != CHCNAV_RETURN_OK) {
      printf(
          "Set mounted position %d camera's zoom in failed, error code: %d\r\n",
          position, ret);
      return;
    }
    sleep(5);
    ...
    if (ret != CHCNAV_RETURN_OK) {
      printf("Set mounted position %d camera's stop zoom failed, error code: "
             "%d\r\n",
             position, ret);
      return;
    }
    sleep(1);
    ret = chcnav_camera_manager_start_continuous_zoom(
        position, CHCNAV_CAMERA_ZOOM_DIRECTION_OUT);
    if (ret != CHCNAV_RETURN_OK) {
      printf("Set mounted position %d camera's zoom out failed, error code: "
             "%d\r\n",
             position, ret);
      return;
    }
  ...
  case CHCNAV_TEST_CAMERA_MANAGER_SAMPLE_SELECT_SHOOT_SINGLE_PHOTO: {
    ...
    if (ret != CHCNAV_RETURN_OK) {
      printf("Start mounted position %d camera's single photo failed, error "
             "code: %d\r\n",
             position, ret);
      return;
    }
  ...
  case CHCNAV_TEST_CAMERA_MANAGER_SAMPLE_SELECT_SHOOT_INTERVAL_PHOTO: {
    ...
    if (ret != CHCNAV_RETURN_OK) {
      printf("Start mounted position %d camera's Interval photo failed, error "
             "code: %d\r\n",
             position, ret);
      return;
    }
    ...
    if (ret != CHCNAV_RETURN_OK) {
      printf("Stop mounted position %d camera's Interval photo failed, error "
             "code: %d\r\n",
             position, ret);
      return;
    }
  ...
  case CHCNAV_TEST_CAMERA_MANAGER_SAMPLE_SELECT_RECORD_VIDEO: {
    ...
    if (ret != CHCNAV_RETURN_OK) {
      printf("Start mounted position %d camera's record failed, error code: "
             "%d\r\n",
             position, ret);
      return;
    }
    ...
    if (ret != CHCNAV_RETURN_OK) {
      printf(
          "Stop mounted position %d camera's record failed, error code: %d\r\n",
          position, ret);
      return;
    }
    break;
  ...
  case CHCNAV_TEST_CAMERA_MANAGER_SAMPLE_SELECT_SHOW_STORAGE_INFO: {
    ...
    printf("total capacity: %d, remainCapcity: %d", storage_info.total_capacity,
           storage_info.remain_capacity);
    break;
  }
  case CHCNAV_TEST_CAMERA_MANAGER_SAMPLE_SELECT_FORMAT_SD_CARD: {
    ...
    if (ret != CHCNAV_RETURN_OK) {
      printf("Start mounted position %d camera's format SD Card failed, error "
             "code: %d\r\n",
             position, ret);
      return;
    }
  ...
  case CHCNAV_TEST_CAMERA_MANAGER_SAMPLE_SELECT_RESET_CAMERA_SETTINGS: {
    ...
    if (ret != CHCNAV_RETURN_OK) {
      printf("Start mounted position %d camera's reset setting failed, error "
             "code: %d\r\n",
             position, ret);
      return;
    }
  ...
  case CHCNAV_TEST_CAMERA_MANAGER_SAMPLE_SELECT_SET_METERING_MODE: {
    ...
    if (ret != CHCNAV_RETURN_OK) {
      printf("Set mounted position %d camera's metering mode failed, error "
             "code: %d\r\n",
             position, ret);
      return;
    }
    ...
    if (ret != CHCNAV_RETURN_OK) {
      printf("Get mounted position %d camera's metering mode failed, error "
             "code: %d\r\n",
             position, ret);
      return;
    }
  ...
  case CHCNAV_TEST_CAMERA_MANAGER_SAMPLE_SELECT_SET_METERING_POINT: {
    ...
    ret = chcnav_camera_manager_set_metering_mode(
        position, CHCNAV_CAMERA_MANAGER_METERING_MODE_SPOT);
    if (ret != CHCNAV_RETURN_OK) {
      printf("Set mounted position %d camera's metering mode failed, error "
             "code: %d\r\n",
             position, ret);
    ...
    ret = chcnav_camera_manager_get_metering_point_region_range(
        position, &hrz_num, &vtc_num);
    if (ret != CHCNAV_RETURN_OK) {
      printf("Get mounted position %d camera's spot metering mode range "
             "failed, error code: %d\r\n",
             position, ret);
      return;
    }
    ...
    if (ret != CHCNAV_RETURN_OK) {
      printf("Set mounted position %d camera's spot metering mode range "
             "failed, error code: %d\r\n",
             position, ret);
      return;
    }
...
void chcnav_run_camera_manager_sample() {
  ...
  printf("chcnav_run_camera_manager_sampl...\n");
  while (true) {
    cout << "| Available position:                                             "
            "                                 |"
         << endl;
    cout << "| [1] Select gimbal mount position at NO.1 payload port           "
            "                                 |"
         << endl;
    cout << "| [2] Select gimbal mount position at NO.2 payload port           "
            "                                 |"
         << endl;
    cout << "| [3] Select gimbal mount position at NO.3 payload port           "
            "                                 |"
         << endl;
    cout << "| [q] Quit                                                        "
            "                                 |"
    ...
    cameraMountPosition =
        static_cast<CHCNAV_MOUNT_POSITION_E>(atoi(mountPositionStr.c_str()));
    if (cameraMountPosition > CHCNAV_MOUNT_POSITION_PAYLOAD_PORT_NO3 ||
        cameraMountPosition < CHCNAV_MOUNT_POSITION_PAYLOAD_PORT_NO1) {
  ...
  while (!connect_status) {
    ...
    chcnav_camera_manager_get_camera_connect_status(cameraMountPosition,
                                                    &connect_status);
    if (connect_count > 10) {
  ...
  ret =
      chcnav_camera_manager_get_camera_type(cameraMountPosition, &camera_type);
  if (ret != CHCNAV_RETURN_OK) {
  ...
  ret =
      chcnav_camera_manager_get_firmware_version(cameraMountPosition, &version);
  if (ret != CHCNAV_RETURN_OK) {
    printf("Get mounted position %d camera's firmware version failed, error "
           "code: %d\r\n",
           cameraMountPosition, ret);
    goto ExitCameraManager;
  }
  printf("Mounted position %d camera's firmware is V%02d.%02d.%02d.%02d\r\n",
         cameraMountPosition, version.firmware_version[0],
         version.firmware_version[1], version.firmware_version[2],
  ...
  while (true) {
    ...
    cameraSample =
        (CHCNAV_TEST_CAMERA_MANAGER_SAMPLE_E)atoi(sampleSelectStr.c_str());
